        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CidadesDestino_PaisesDestino_PaisId",
                        column: x => x.PaisId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PacoteCidadeDestino", x => new { x.DestinosId, x.PacotesId });
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PacoteCidadeDestino_PacotesTuristicos_PacotesId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CidadesDestino_PaisId",
                table: "CidadesDestino",
                column: "PaisId");

            migrationBuilder.CreateIndex(
                name: "IX_PacoteCidadeDestino_PacotesId",
